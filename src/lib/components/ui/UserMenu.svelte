<script>
  ...
  <div class="relative" bind:this={menuRef}>
    <button 
      class="flex items-center text-amber-100 hover:text-white transition-colors p-1"
      on:click={toggleMenu}
    ...
    {#if menuOpen}
      <div class="absolute right-0 mt-2 w-48 bg-stone-800 border border-amber-800/30 rounded-lg shadow-lg z-50 py-1 overflow-hidden">
        {#if user}
          <!-- Logged in state -->
