<script>
    ...
    function toggleCommentSection(quoteId) {
      if (expandedCommentSections.has(quoteId)) {
        expandedCommentSections.delete(quoteId);
      } else {
        expandedCommentSections.add(quoteId);
        if (!comments[quoteId]) {
  ...
  <section class="container mx-auto py-8">
    <h1 class="text-3xl font-bold mb-6 text-center">Quotes of Wisdom</h1>
